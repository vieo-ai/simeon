...
### 3. Unisciti alla community Simeon
...
- Per la documentazione, visita [Simeon Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
Inviando una pull request, accetti che i tuoi contributi siano concessi in licenza sotto la Licenza Apache 2.0, in linea con la licenza di Simeon.
