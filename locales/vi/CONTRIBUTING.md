...
- Về tài liệu, hãy xem [Simeon Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
Khi gửi pull request, bạn đồng ý rằng đóng góp của mình sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với giấy phép của Simeon.
